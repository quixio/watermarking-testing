 ...
 # ── Watermark debug instrumentation ───────────────────────────────────────
  ...
  def _dbg_receive(self, message):                                                                                                                                                                                                                                                                             result = _orig_wm_recv(self, message)
      if result is not None:                                                                                                                                                                                                                                                                             
          ...
          if stuck:                                                                                                                                                                                                                                                                                                    logger.warning("[WM] STUCK at -1: %s", stuck)
      return result                                                                                                                                                                                                                                                                                      
                                                                                                                                                                                                                                                                                                           _wm_mod.WatermarkManager.set_topics = _dbg_set_topics                                                                                                                                                                                                                                                  
  _wm_mod.WatermarkManager.receive    = _dbg_receive                                                                                                                                                                                                                                                     

  # Periodic TP dump — call this from your SDF pipeline                                                                                                                                                                                                                                                    _last_wm_dump = [0.0]
  def _wm_dump(value):                                                                                                                                                                                                                                                                                   
      now = time.monotonic()                                                                                                                                                                                                                                                                                   if now - _last_wm_dump[0] >= 30.0:                                                                                                                                                                                                                                                                 
          _last_wm_dump[0] = now                                                                                                                                                                                                                                                                         
          if _wm_instance[0] is not None:                                                                                                                                                                                                                                                                              rows = sorted(_wm_instance[0]._watermarks.items())                                                                                                                                                                                                                                         
              logger.info(                                                                                                                                                                                                                                                                                                 "[WM] dump:\n%s",
                  "\n".join(                                                                                                                                                                                                                                                                                                   f"  {'STUCK' if v == -1 else '     '} {t}[{p}] = {v}"
                      for (t, p), v in rows                                                                                                                                                                                                                                                              
                  ),                                                                                                                                                                                                                                                                                     
              )                                                                                                                                                                                                                                                                                                return value                                                                                                                                                                                                                                                                                       
  # ──────────────────────────────────────────────────────────────────────────                                                                                                                                                                                                                          
